...
void main() {
  ...
  // (N22) `LifecycleHost` (in `lib/src/framework_overrides.dart`)
  ...
  // (N23) `IsolatedSub` is instantiated so `unused_class` stays quiet.
...
class Service {
  ...
  // (N23) Public static method; exempt as package API surface.
  static void unusedStaticMethod() {}

  // (N23) Public getter; exempt as package API surface.
  int get unusedGetter => 0;

  // (N23) Public setter; exempt as package API surface.
  set unusedSetter(int value) {}

  // (N23) Public operator; exempt as package API surface.
...
// (N23) Public extension method outside `lib/src`; exempt as package
...
// (N23) Public override on a public type outside `lib/src`; exempt as
...
class NoSuchMethodTarget {
  // (N23) Public method on a public class outside `lib/src`; exempt as
...
//
// (N23) Public instance/static methods, getters, setters, and operators
...
/// (N23) Public enum declared outside `lib/src/`. Its public member is
