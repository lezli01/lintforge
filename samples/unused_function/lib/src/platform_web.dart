...
// configuration of the export, the `unused_function` rule treats its
// public declarations as conditional-export branch surface. The public
// top-level function and the public class members below live under
// `lib/src/`, so they are NOT covered by the
